...
Route::post('/shopping-cart',['uses'=>'ProductController@postCart','as'=>'product.shoppingcart']);
Route::get('/reduce/{id}',['uses'=>'ProductController@getReduceOne','as'=>'product.reduceone']);
Route::get('/reduceall/{id}',['uses'=>'ProductController@getReduceAll','as'=>'product.reduceAll']);
